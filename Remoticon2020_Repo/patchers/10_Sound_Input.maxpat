...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 255.5, 74.0, 254.0, 47.0 ],
									"text" : "credit: https://cycling74.com/forums/fastest-onset-detection-native-or-external"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 167.0, 535.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 297.0, 175.0, 80.0, 13.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 167.0, 423.0, 32.5, 32.5 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 318.0, 207.5, 150.0, 47.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 240.0, 374.0, 63.0, 22.0 ],
									"text" : "delay 150"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 167.0, 374.0, 67.0, 22.0 ],
									"text" : "onebang 1"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 22.568176000000001, 237.0, 44.0, 20.0 ],
													"text" : "+ 0.05"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 22.568176000000001, 174.0, 47.0, 18.0 ],
													"text" : "$1 200"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 22.568176000000001, 201.0, 46.0, 20.0 ],
													"text" : "line 0."
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 22.568176000000001, 147.0, 38.0, 19.0 ],
													"text" : "mean"
												}
...
,
									"patching_rect" : [ 234.0, 221.0, 77.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 283.0, 329.0, 199.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 332.0, 346.0, 26.0, 20.0 ],
									"text" : "ms"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 284.0, 346.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 167.0, 346.0, 36.0, 22.0 ],
									"text" : "sel 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 167.0, 286.0, 86.0, 22.0 ],
									"text" : "> 0.2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 167.0, 251.0, 32.5, 22.0 ],
									"text" : "- 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 180.5, 221.0, 46.0, 22.0 ],
									"text" : "bucket"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 167.0, 178.0, 77.0, 22.0 ],
									"text" : "peakamp~ 1"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 176.5, 208.0, 190.0, 208.0 ],
									"order" : 1,
									"source" : [ "obj-41", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 176.5, 208.0, 243.5, 208.0 ],
									"order" : 0,
									"source" : [ "obj-41", 0 ]
								}
